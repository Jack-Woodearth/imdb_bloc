...
class TrailersWidget extends StatefulWidget {
  const TrailersWidget({super.key, required this.movieBean});
                      ...
                      : CarouselSlider.builder(
                          ...
                          itemBuilder: (context, index, realIndex) {
                            ...
                            if (!(e.videoRenderer?.thumbnail?.thumbnails
                                        ?.isNotEmpty ==
                                    true &&
                                !isBlank(e.videoRenderer!.thumbnail!
                                    .thumbnails![0].url))) {
                              return MyNetworkImage(
                                  url: bigPic(widget.movieBean.videos
                                                  ?.isNotEmpty ==
                                              true &&
